...
tiff(file = paste0("results/maps/sGSL geography - ", language, ".tiff"), compression = "lzw", units = "in", res = 300, height = height, width = width)
...
text(-62.35, 47.5, magdalen.str, srt = 65, cex = 0.55, font = 3)
text(-61.22, 47.10, cape.breton.str, srt = 54, cex = 0.55, font = 3)
text(-63.83, 48.55, american.str, srt = 0, cex = 0.7, font = 3)
text(-62.9, 47.4, bradelle.str, srt = 0, cex = 0.7, font = 3)
...
# Fishing zones:
text(-63.5, 47.5, zone12.str, srt = 0, cex = 1.0, font = 2)
